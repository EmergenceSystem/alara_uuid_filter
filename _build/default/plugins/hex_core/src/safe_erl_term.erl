...
-file("c:/Users/steve/dev/search/EmergenceSystem/filters/alara_uuid_filter/_build/default/plugins/hex_core/src/safe_erl_term.xrl", 24).
...
-file("c:/Users/steve/dev/search/EmergenceSystem/filters/alara_uuid_filter/_build/default/plugins/hex_core/src/safe_erl_term.erl", 392).
yystate() -> 12.
...
-file("c:/Users/steve/dev/search/EmergenceSystem/filters/alara_uuid_filter/_build/default/plugins/hex_core/src/safe_erl_term.xrl", 12).
yyaction_0(TokenChars, TokenLine) ->
     tokenize_atom (TokenChars, TokenLine) .

-compile({inline,yyaction_1/3}).
-file("c:/Users/steve/dev/search/EmergenceSystem/filters/alara_uuid_filter/_build/default/plugins/hex_core/src/safe_erl_term.xrl", 13).
yyaction_1(TokenChars, TokenLen, TokenLine) ->
     tokenize_atom (escape (unquote (TokenChars, TokenLen)), TokenLine) .

-compile({inline,yyaction_2/3}).
-file("c:/Users/steve/dev/search/EmergenceSystem/filters/alara_uuid_filter/_build/default/plugins/hex_core/src/safe_erl_term.xrl", 14).
yyaction_2(TokenChars, TokenLen, TokenLine) ->
     { token, { string, TokenLine, escape (unquote (TokenChars, TokenLen)) } } .

-compile({inline,yyaction_3/2}).
-file("c:/Users/steve/dev/search/EmergenceSystem/filters/alara_uuid_filter/_build/default/plugins/hex_core/src/safe_erl_term.xrl", 15).
yyaction_3(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_4/2}).
-file("c:/Users/steve/dev/search/EmergenceSystem/filters/alara_uuid_filter/_build/default/plugins/hex_core/src/safe_erl_term.xrl", 16).
yyaction_4(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_5/2}).
-file("c:/Users/steve/dev/search/EmergenceSystem/filters/alara_uuid_filter/_build/default/plugins/hex_core/src/safe_erl_term.xrl", 17).
yyaction_5(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("c:/Users/steve/dev/search/EmergenceSystem/filters/alara_uuid_filter/_build/default/plugins/hex_core/src/safe_erl_term.xrl", 18).
yyaction_6(TokenLine) ->
     { token, { dot, TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("c:/Users/steve/dev/search/EmergenceSystem/filters/alara_uuid_filter/_build/default/plugins/hex_core/src/safe_erl_term.xrl", 19).
yyaction_7(TokenLine) ->
     { token, { '/', TokenLine } } .

-compile({inline,yyaction_8/0}).
-file("c:/Users/steve/dev/search/EmergenceSystem/filters/alara_uuid_filter/_build/default/plugins/hex_core/src/safe_erl_term.xrl", 20).
yyaction_8() ->
     skip_token .
